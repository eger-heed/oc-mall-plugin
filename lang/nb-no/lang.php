...
return [
    'plugin' => [
        'name' => 'Mall',
        'description' => 'E-handelsløsning for October CMS',
    ],
    'titles' => [
        'products' => [
            'create' => 'Opprett produkt',
            'update' => 'Rediger produkt',
            'preview' => 'Forhåndsvis produkt',
        ],
        'categories' => [
            'create' => 'Opprett kategori',
            'update' => 'Rediger kategori',
            'preview' => 'Forhåndsvis kategori',
        ],
        'orders' => [
            'show' => 'Ordredetaljer',
            'export' => 'Ekspotér ordre',
        ],
        'discounts' => [
            'create' => 'Opprett kampanje',
            'update' => 'Rediger kampanje',
            'preview' => 'Forhåndsvis kampanje',
        ],
        'services' => [
            'create' => 'Opprett tjeneste',
            'update' => 'Rediger tjeneste',
        ],
        'shipping_methods' => [
            'create' => 'Opprett fraktmetode',
            'update' => 'Rediger fraktmetode',
            'preview' => 'Forhåndsvis fraktmetode',
        ],
        'payment_methods' => [
            'create' => 'Opprett betalingsmåte',
        ...
        'properties' => [
            'create' => 'Opprett egenskaper',
            'edit' => 'Rediger egenskaper',
        ],
        'order_states' => [
        ...
        'reviews' => [
            'create' => 'Opprett omtale',
            'update' => 'Rediger omtale',
        ],
    ],
    'menu_items' => [
        'all_categories' => 'Alle kategorier',
        'single_category' => 'Enkeltkategori',
        'all_products' => 'Alle produkter',
        'all_variants' => 'Alle varianter',
    ],
    'currency_settings' => [
        'label' => 'Valuta',
        'description' => 'Innstillinger for valute',
        'currencies' => 'Skriv bare inn offisielle valuta koder med 3 bokstaver.',
        'currency_code' => 'Valutakode',
        'currency_decimals' => 'Antall desimaler',
        'currency_rounding' => 'Avrunding',
        'currency_rounding_comment' => 'Total inkludert mva avrundes til denne verdien hvis denne valutaen er aktivert.',
        'currency_format' => 'Format',
        'currency_symbol' => 'Symbol',
        'currency_rate' => 'Kurs',
        'is_default' => 'Standard',
        'unknown' => 'Ukjent valuta',
    ],
    'payment_gateway_settings' => [
        'label' => 'Betalingsmåter',
        'description' => 'Innstillinger for betalingsmåter',
        'stripe' => [
            'api_key' => 'Stripe API-nøkkel',
            'api_key_comment' => 'Denne finner du i ditt Stripe dashboard',
            'publishable_key' => 'Stripe Publishable nøkkel',
            'publishable_key_comment' => 'Denne finner du i ditt Stripe dashboard',
        ],
        'paypal' => [
            'client_id' => 'PayPal klient ID',
            'secret' => 'PayPal hemmelig nøkkel',
            'test_mode' => 'Test modus',
            'test_mode_comment' => 'Send alle betalinger til PayPal Sandbox.',
        ],
        'postfinance' => [
            'test_mode' => 'Testmodus',
            'test_mode_comment' => 'Kjør alle betalinger i testmodus.',
            'pspid' => 'PSPID (Brukernavn)',
    ...
    'notification_settings' => [
        'label' => 'Varslinger',
        'description' => 'Innstillinger for varslinger',
    ],
    'price_category_settings' => [
        'label' => 'Priskategorier',
        'description' => 'Oppsett for priskategorier',
    ],
    'order_state_settings' => [
        'description' => 'Rediger ordrestaus',
    ],
    'payment_method_settings' => [
        'description' => 'Behandle betalingsmåter',
    ],
    'shipping_method_settings' => [
        'description' => 'Behandle fraktmåter',
    ],
    'tax_settings' => [
        'description' => 'Behandle merverdiavgift',
    ],
    'general_settings' => [
